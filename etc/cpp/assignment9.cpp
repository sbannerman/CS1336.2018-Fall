...
int main()
{
	...
	cout << "Item 1 price:   $" << priceOfItem1 << endl;

	double priceOfItem2 = 24.95;
	cout << "Item 2 price:   $" << priceOfItem2 << endl;

	double priceOfItem3 = 6.95;
	cout << "Item 3 price:   $" << priceOfItem3 << endl;

	double priceOfItem4 = 14.95;
	cout << "Item 4 price:   $" << priceOfItem4 << endl;

	double priceOfItem5 = 3.95;
	cout << "Item 5 price:   $" << priceOfItem5 << endl;
